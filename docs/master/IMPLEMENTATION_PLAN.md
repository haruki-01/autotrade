...
| EV | +0.731 / +0.595 / +0.537（DD 14〜19%、n=133/143/212） |
| 系統全体 | 23本中20本が3期間ともEVプラス |
| 買い持ち比（Set C） | 戦略 **+38.0%** 対 買い持ち **−33.1%**（DD 18.9% 対 64.2%） |
| 反証（1日遅延） | 3期間ともプラスのまま＝先読みではない |

**採用はまだ保留。** 23本は1つの機構を共有しており実質1試行に近く、
ゲートを通った1本は系統内でEVが最も低い設定（固定利確でDDと回数を稼いでいる）。
