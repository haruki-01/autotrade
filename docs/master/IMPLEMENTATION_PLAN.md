...
- **(3) 入口①を優位軸で再採点:** BR-001〜008 は不採用。ADV-001〜006 を起票。
- **(4) ADV-002/001/005/004 を各10回（1点差分・1年）:** 決済EV黒 0/40。8年は回していない。
  レポート: `eval/reports/20260825-adv-cycles.md`
...
**「月120%」は元本300基準で確定**（春希さん、2026-08-25）。月360 USDT、必要 N×Q²=3.00、実測との差17倍。
複利では年約11,700倍。検証の合否（EV>0）とは別の、到達可能性の話として残す。
